...
let
  ...
  packages = { fetchNuGet }: commonPackages fetchNuGet
    ++ builtins.concatLists (builtins.attrValues (hostPackages fetchNuGet)
      ++ builtins.attrValues (targetPackages fetchNuGet));

  mapRIDs = { linux-arm64, linux-x64, osx-arm64, osx-x64, ... }: {
